...
SETTING_SPECS = {
    ...
    "bound_select": SettingSpec("bound", _int_choice(C.BOUND_WIDTHS), 0),
    "cap_select": SettingSpec("cap", _int_choice(C.CAPS), C.DEFAULT_CAP),
}
PRESET_KEYS = {"network": "network_select", "side": "side_slider", "obstacle_pct": "obstacle_slider", "seed": "seed_input", "width": "width_select", "bound_width": "bound_select", "cap": "cap_select"}
